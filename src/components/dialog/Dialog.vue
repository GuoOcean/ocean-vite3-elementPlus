  ...
  <div class="m-dialog-root">
    ...
    >
      ...
      >
        ...
        >
          <div
            class="m-dialog-body-wrap"
            :class="bodyClass"
            :style="dialogBodyStyle"
          >
            <div
              class="dialog-header"
              :class="{ 'header-with-switch': switchFullscreen }"
              :style="titleStyle"
            >
            ...
            <span class="close-action" @click="onCancel" v-if="closable">
              <svg
                width="1em"
                height="1em"
                fill="currentColor"
            ...
            <div v-if="footer" class="dialog-footer">
              <slot name="footer">
                ...
                <el-button class="mr8" @click="onCancel" v-bind="cancelProps">{{
                  cancelText
                }}</el-button>
                <el-button
                  :type="okType"
